...
const copy = {
  en: {
    ...
    galleryText: "Browse 42 real moments from our trips around Fajardo and Puerto Rico’s eastern islands.",
    galleryCount: "42 real trip photos",
    galleryOpenAll: "View all 42 photos",
  ...
  es: {
    ...
    galleryText: "Recorre 42 momentos reales de nuestros viajes por Fajardo y las islas del este de Puerto Rico.",
    galleryCount: "42 fotos reales de nuestros viajes",
    galleryOpenAll: "Ver las 42 fotos",
